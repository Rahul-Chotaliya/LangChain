...
class Review(TypedDict):
    ...
    pros : Annotated[Optional[List[str]], "Positive aspects mentioned in the review, if any"]
    cons : Annotated[Optional[List[str]], "Negative aspects mentioned in the review, if any"]
